...
var linkSel = 'h3.gs_rt a'
  , descSel = '.gs_rs'
  , itemSel = 'div.gs_ri'
  , nextSel = 'span.gs_ico_nav_next';

var URL = 'http://scholar.google.com/scholar?hl=en&q=%s&start=%s&sa=N&num=%s&ie=UTF-8&oe=UTF-8';
    ...
    if ((err == null) && resp.statusCode === 200) {
      ...
      $(itemSel).each(function(i, elem) {
        var linkElem = $(elem).find(linkSel)
          ...
          , item = {title: $(linkElem).text(), link: $(linkElem).attr('href'), description: null, href: null}
